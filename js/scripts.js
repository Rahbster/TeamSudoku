...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    dom.spellingbeeConfigMode = document.getElementById('spellingbee-config-mode');
    dom.spellingbeeConfigWordList = document.getElementById('spellingbee-config-wordlist');
    ...
    dom.blackjackConfigContainerAICount = document.getElementById('blackjack-config-container-aicount');
